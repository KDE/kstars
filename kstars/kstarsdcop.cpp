...
void KStars::startINDI (const QString &deviceName, bool useLocal)
{
    ...
    if (found.empty())
    {
        qDebug() << "Device " << deviceName << " not found!";
        return;
    }
...
void KStars::switchINDI(bool turnOn)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "switchINDI: establishINDI() failed.";
        return;
    }
    ...
    if (!dev)
    {
        qDebug() << "Device " << indimenu->getCurrentDevice() << " not found!";
        return;
    }
...
void KStars::setINDIPort(const QString &port)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDIPort: establishINDI() failed.";
        return;
    }
...
void KStars::setINDITargetCoord(double RA, double DEC)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDITarget: establishINDI() failed.";
        return;
    }
...
void KStars::setINDIAction(const QString &action)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDIAction: establishINDI() failed.";
        return;
    }
...
void KStars::waitForINDIAction(const QString &action)
{
    ...
    //  if (!indidriver || !indimenu)
    //  {
    //    qDebug() << "waitForINDIAction: establishINDI() failed.";
    //    return;
    //  }
    //
    //  dev = indimenu->findDevice(indimenu->getCurrentDevice());
...
void KStars::setINDIFocusSpeed(unsigned int speed)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDIFocusSpeed: establishINDI() failed.";
        return;
    }
...
void KStars::startINDIFocus(int focusDir)
{
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDIFocus: establishINDI() failed!";
        return;
    }
...
void KStars::setINDIGeoLocation(double longitude, double latitude)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDIGeoLocation: establishINDI() failed.";
        return;
    }
...
void KStars::setINDIFocusTimeout(int timeout)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "startINDIFocus: establishINDI() failed.";
        return;
    }
...
void KStars::startINDIExposure(int timeout)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "startINDIExposure: establishINDI() failed.";
        return;
    }
...
void KStars::setINDIFilterNum(int filter_num)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDIFilterNum: establishINDI() failed.";
        return;
    }
...
void KStars::setINDIUTC(const QString &UTCDateTime)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "startINDIUTC: establishINDI() failed.";
        return;
    }
...
void KStars::setINDICCDTemp(int temp)
{
    ...
    if (!indidriver || !indimenu)
    {
        qDebug() << "setINDICCDTemp: establishINDI() failed.";
        return;
    }

...
class DetailsTable
{
    public:
        ...
        /**
          ...
          */
        inline QTextTableFormat getTableFormat()
        {
        ...
        /**
          ...
          */
        inline QTextCharFormat getTableTitleCharFormat()
        {
            return m_TableTitleCharFormat;
        }
        ...
        /**
          ...
          */
        inline QTextCharFormat getItemNameCharFormat()
        {
            return m_ItemNameCharFormat;
        }
        ...
        /**
          ...
          */
        inline QTextCharFormat getItemValueCharFormat()
        {
            return m_ItemValueCharFormat;
        }
        ...
        /**
          ...
          */
        inline void setTableFormat(const QTextTableFormat &format)
        {
            m_TableFormat = format;
        }
        ...
        /**
          ...
          */
        inline void setTableTitleCharFormat(const QTextCharFormat &format)
        {
            m_TableTitleCharFormat = format;
        }
        ...
        /**
          ...
          */
        inline void setItemNameCharFormat(const QTextCharFormat &format)
        {
            m_ItemNameCharFormat = format;
        }
        ...
        /**
          ...
          */
        inline void setItemValueCharFormat(const QTextCharFormat &format)
        {
            m_ItemValueCharFormat = format;
        }
        ...
        /**
          ...
          */
        inline QTextDocument * getDocument()
        {
            return m_Document;
        }

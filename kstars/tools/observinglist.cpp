...
if ( sessionView ) {
    ...
    QSortFilterProxyModel *currentSortModel = sessionView ? m_SortModelSession : m_SortModel;

    selectedItems = currentSortModel->mapSelectionToSource( currentView->selectionModel()->selection() ).indexes();

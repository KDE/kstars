...
class BinFileHelper
{
    ...
    public:
         ...
         */
        inline bool propertiesUpdated() const
        {
            return indexUpdated;
        }
         ...
         */
        inline long getOffset(int id) const
        {
            return (indexUpdated ? indexOffset.at( id ) : 0);
        }
         ...
         */
        inline unsigned int getRecordCount(int id) const
        {
            return (indexUpdated ? indexCount.at( id ) : 0);
        }
         ...
         */
        inline unsigned long getRecordCount() const
        {
            return (indexUpdated ? recordCount : 0);
        }
         ...
         */
        inline int guessRecordSize() const
        {
            return (RSUpdated ? recordSize : 0);
        }
         ...
         */
        inline QString getHeaderText() const
        {
            return (preambleUpdated ? headerText : "");
        }
        ...
        {
            return (indexUpdated ? dataOffset : 0);
        }
         ...
         */
        inline long getIndexTableOffset() const
        {
            return (FDUpdated ? itableOffset : 0);
        }

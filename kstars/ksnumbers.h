...
class KSNumbers
{
    public:
        ...
        /** @return the current Obliquity (the angle of inclination between
        	...
        	*/
        inline const CachingDms * obliquity() const
        {
            return &Obliquity;
        }

        /** @return the constant of aberration (20.49 arcsec). */
        inline dms constAberr() const
        {
            return K;
        }

        /** @return the mean solar anomaly. */
        inline dms sunMeanAnomaly() const
        {
            return M;
        }

        /** @return the mean solar longitude. */
        inline dms sunMeanLongitude() const
        {
            return L;
        }

        /** @return the true solar anomaly. */
        inline dms sunTrueAnomaly() const
        {
            return M0;
        }

        /** @return the true solar longitude. */
        inline CachingDms sunTrueLongitude() const
        {
            return L0;
        }

        /** @return the longitude of the Earth's perihelion point. */
        inline CachingDms earthPerihelionLongitude() const
        {
            return P;
        }

        /** @return eccentricity of Earth's orbit.*/
        inline double earthEccentricity() const
        {
            return e;
        }
         ...
         * Value is in degrees. */
        inline double dEcLong() const
        {
            return deltaEcLong;
        }

        /** @return Julian centuries since J2000*/
        inline double julianCenturies() const
        {
            return T;
        }

        /** @return Julian Day*/
        inline long double julianDay() const
        {
            return days;
        }

        /** @return Julian Millenia since J2000*/
        inline double julianMillenia() const
        {
            return jm;
        }

        /** @return element of P1 precession array at position (i1, i2) */
        inline double p1( int i1, int i2 ) const
        {
            return P1(i1, i2);
        }

        /** @return element of P2 precession array at position (i1, i2) */
        inline double p2( int i1, int i2 ) const
        {
            return P2(i1, i2);
        }

        /** @return element of P1B precession array at position (i1, i2) */
        inline double p1b( int i1, int i2 ) const
        {
            return P1B(i1, i2);
        }

        /** @return element of P2B precession array at position (i1, i2) */
        inline double p2b( int i1, int i2 ) const
        {
            return P2B(i1, i2);
        }

        /** @return the precession matrix directly **/
        inline const Eigen::Matrix3d &p2() const
        {
            return P1;
        }
        inline const Eigen::Matrix3d &p1() const
        {
            return P2;
        }
        inline const Eigen::Matrix3d &p1b() const
        {
            return P1B;
        }
        inline const Eigen::Matrix3d &p2b() const
        {
            return P2B;
        }
         ...
         */
        inline long double getJD() const
        {
            return days;
        }

        inline double vEarth(int i) const
        {
            return vearth[i];
        }

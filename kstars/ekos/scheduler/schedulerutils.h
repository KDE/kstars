...
class SchedulerUtils
{
    public:
         ...
         */
        static void setupJob(SchedulerJob &job, const QString &name, bool isLead, const QString &group, const QString &train,
                             const dms &ra, const dms &dec,
                             ...
                             double minimumAltitude, double minimumMoonSeparation, double maxMoonAltitude, bool enforceTwilight,
         ...
         */
        static uint16_t fillCapturedFramesMap(const CapturedFramesMap &expected, const CapturedFramesMap &capturedFramesCount,
         ...
         */
        static void updateLightFramesRequired(SchedulerJob *oneJob, const QList<QSharedPointer<SequenceJob> > &seqjobs,
        ...
        static bool loadSequenceQueue(const QString &fileURL, SchedulerJob *schedJob, QList<QSharedPointer<SequenceJob> > &jobs,
         ...
         */
        static uint16_t calculateExpectedCapturesMap(const QList<QSharedPointer<SequenceJob> > &seqJobs,
        ...
        /**
             ...
             */
        static double findAltitude(const SkyPoint &target, const QDateTime &when, bool *is_setting = nullptr,
                                   GeoLocation *geo = nullptr, bool debug = false);

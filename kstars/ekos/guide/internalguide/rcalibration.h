...
class internalCalibration: public QWidget
{
    ...
    public:
        ...
        {
            return ui.spinBox_ReticleAngle->value();
        }

        bool isCalibrating();
        bool isCalibrationComplete()
        {
            return (calibrationStage == CAL_FINISH || calibrationStage == CAL_ERROR);
        }
        bool isCalibrationSuccessful()
        {
            return (calibrationStage == CAL_FINISH);
        }

        bool useAutoStar()
        {
            return ui.autoStarCheck->isChecked();
        }
        bool useAutoSquareSize()
        {
            return ui.autoSquareSizeCheck->isChecked();
        }
        bool useTwoAxis()
        {
            return ui.twoAxisCheck->isChecked();
        }

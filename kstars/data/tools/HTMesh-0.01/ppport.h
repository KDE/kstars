...
----------------------------------------------------------------------
    ...
    perl 5.008008 on Sat May 27 20:29:12 2006.
...
/* newCONSTSUB from IO.xs is in the core starting with 5.004_63 */
    ...
    ((PERL_VERSION != 4) || (PERL_SUBVERSION != 5))
...
#define SvPVbyte(sv, lp) \
    ((SvFLAGS(sv) & (SVf_POK | SVf_UTF8)) == (SVf_POK) ? ((lp = SvCUR(sv)), SvPVX(sv)) : sv_2pvbyte(sv, &lp))
...
#define CopSTASH_eq(c, hv) \
    ((hv) && (CopSTASHPV(c) == HvNAME(hv) || (CopSTASHPV(c) && HvNAME(hv) && strEQ(CopSTASHPV(c), HvNAME(hv)))))
#endif
    ...
    UV DPPP_(my_grok_oct)(pTHX_ char *start, STRLEN *len_p, I32 *flags, NV *result)
{
    ...
    for (; len-- && *s; s++)
    {
        ...
        if (digit == ('_' - '0') && len && allow_underscores && (digit = s[1] - '0') && (digit >= 0 && digit <= 7))
        {
            --len;
            ++s;
            goto redo;

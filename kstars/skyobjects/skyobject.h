...
class SkyObject : public SkyPoint
{
    public:
        ...
        {
            return hasName() ? Name : unnamedString;
        }
        ...
        {
            return i18n( name().toUtf8() );   // FIXME: Hmm... that's funny. How does the string extraction work, if we are UTF8-ing the name first? Does the string extraction change to UTF8?
        }

        /** @return object's secondary name */
        inline QString name2( void ) const
        {
            return ( hasName2() ? Name2 : emptyString );
        }
        ...
        {
            return hasLongName() ? LongName : unnamedObjectString;
        }
         ...
         */
        inline virtual double pa() const
        {
            return 0.0;
        }

        /** *@return true if the object is a solar system body. */
        inline bool isSolarSystem() const
        {
            return ( type() == 2 || type() == 9 || type() == 10 || type() == 12 );
        }
    ...
    protected:
        ...
        {
            sortMagnitude = m < 36.0 ? m : NaN::f;    // Updating faintest sane magnitude to 36.0 (faintest visual magnitude visible with E-ELT, acc. to Wikipedia on Apparent Magnitude.)
        }
        ...
        inline void setName2( const QString &name2=QString() )
        {
            Name2 = name2;
        }

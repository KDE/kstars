...
public:
    ...
    Filter(const QString &id, const QString &model, const QString &vendor, const FILTER_TYPE type,
           const FILTER_COLOR color)
    {
        setFilter(id, model, vendor, type, color);
    }
    ...
    void setFilter(const QString &id, const QString &model, const QString &vendor, const FILTER_TYPE type, const FILTER_COLOR color);

...
class OAL::Session {
    public:
       Session ( const QString &name, const QString& site, const QStringList& coobservers, const KStarsDateTime& begin,
                 const KStarsDateTime& end, const QString& weather, const QString& equipment, const QString& comment, const QString& lang ) { setSession( name, site, coobservers, begin, end, weather, equipment, comment, lang ); }
       QString id() const { return m_Id; }
       QString site() const { return m_Site; }
       QStringList coobservers() const { return m_Coobservers; }

...
typedef enum { INDI_SEND_COORDS, INDI_ENGAGE_TRACKING, INDI_SET_PORT, INDI_CONNECT, INDI_DISCONNECT, INDI_CAPTURE, INDI_SET_FILTER, INDI_FOCUS_IN, INDI_FOCUS_OUT, INDI_FOCUS_MOVE } DeviceCommand;

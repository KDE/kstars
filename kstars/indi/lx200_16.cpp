...
static ISwtich FieldDeRotatorS		= { {"On", ISS_OFF}, {"Off", ISS_OFF}};
...
static INumber ObjectAlt		= { mydev, "Object Altitude", ILS_IDLE, NULL};
static INumber ObjectAz			= { mydev, "Object Azimuth", ILS_IDLE, NULL};

...
ARGS6="-cppcoreguidelines-pro-type-reinterpret-cast,-readability-redundant-member-init"

# Configure CMake
cmake -Bclang_tidy_build -H.. -DCMAKE_CXX_CLANG_TIDY:STRING="clang-tidy-4.0;$ARGS1,$ARGS2,$ARGS3,$ARGS4,$ARGS5,$ARGS6" \
